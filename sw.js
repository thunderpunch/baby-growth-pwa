const CACHE_NAME="baby-growth-pwa-v1.1.17-baby-icons";
const APP_SHELL=[
  ...
  "./icons/baby-neutral.svg","./icons/baby-girl.svg","./icons/baby-boy.svg","./icons/icon-192.png","./icons/icon-512.png","./icons/apple-touch-icon.png"
];
