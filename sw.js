const CACHE_NAME="baby-growth-pwa-v1.2.2-sleep-entry-v3";
const APP_SHELL=[
  "./","./index.html","./styles.css","./styles-base.css","./layout-fix.css?v=1.1.8","./app.js","./export-ipad.js","./profile-save-guard.js","./baby-name.js","./baby-name.css","./time-behavior.js","./time-picker.css","./recent-milk-template.js","./update-coordinator.js","./gesture-guard.js","./remote-quick-config.js","./icon-theme.js","./icon-theme.css","./migration-v2.js","./sleep-v3.js","./sleep-v3.css","./json-import-v2.js","./export-v2.js","./export-v2.css","./home-config.json","./interaction-guard.css","./db.js","./manifest.webmanifest","./manifest-girl.webmanifest","./manifest-boy.webmanifest",
